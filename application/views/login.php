...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= base_url()?>asset/backend/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo base_url();?>admin"><b>Aplikasi Pemesanan</b></a>
    </div>
  <!-- /.login-logo -->
...
<?php }?>
        <form action="login/login" method="post">
            ...
            <div class="form-group has-feedback">
                ...
                <a href="<?php echo base_url();?>forgot_password">Forgot Your Password?</a><br>
            </div>
