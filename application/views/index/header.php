...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?= base_url()?>asset/backend/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?= base_url()?>asset/backend/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?= base_url()?>asset/backend/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?= base_url()?>asset/backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <link href="<?php echo base_url('asset/backend/plugins/datatables/css/dataTables.bootstrap.css')?>" rel="stylesheet">
